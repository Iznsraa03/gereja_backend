...
<div class='flex justify-between items-center mb-6'>
    ...
    <a href='/admin/activities/create' class='bg-indigo-600 text-white font-medium shadow-lg shadow-indigo-500/20 px-4 py-2 rounded shadow hover:bg-indigo-500 transition-colors duration-200'>Add New</a>
</div>
        ...
        <tbody>
            ...
            <tr class='border-b border-slate-800 hover:bg-slate-800/50'>
                ...
                <td class='p-3 flex gap-2'>
                    <a href='/admin/activities/{{ $item->id }}/edit' class='text-indigo-400 transition-colors duration-200 hover:underline'>Edit</a>
