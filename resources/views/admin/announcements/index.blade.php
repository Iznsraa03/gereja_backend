...
<div class='flex justify-between items-center mb-6'>
    ...
    <a href='/admin/announcements/create' class='bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-700'>Add New</a>
</div>
        ...
        <tbody>
            ...
            <tr class='border-b hover:bg-gray-50'>
                ...
                <td class='p-3 flex gap-2'>
                    <a href='/admin/announcements/{{ $item->id }}/edit' class='text-blue-500 hover:underline'>Edit</a>
