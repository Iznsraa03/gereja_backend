...
<section id="download" class="py-24 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <div class="glass rounded-3xl p-8 max-w-md mx-auto">
            ...
            <a href="/download/ChurchFinderMakassar.apk" download="ChurchFinderMakassar.apk" class="btn-gold text-slate-900 w-full py-4 rounded-2xl font-black text-lg flex items-center justify-center gap-3 cursor-pointer" style="display:flex;">
